  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 pt-20">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 text-white">Copy Trading Agent</h1>
          <p className="text-white/70">
            Follow top-performing traders and let our AI automatically mirror their successful strategies.
          </p>
        </div>
